...
export interface DiagramModel extends ComponentModel{
    ...
    /**
     * Triggers when a node/connector is added/removed to/from the diagram.     * @event
     ...
     * @event
     * @blazorProperty 'OnSegmentCollectionChange'     * @blazorType 'IBlazorSegmentCollectionChangeEventArgs'
     */
    segmentCollectionChange?: EmitType<ISegmentCollectionChangeEventArgs>;

    /**
     * Triggers when the image node is loaded.     * @event
     */
    onImageLoad?: EmitType<IImageLoadEventArgs>;

    /**
     * Triggers when the state of the expand and collapse icon change for a node.     * @event
     ...
     * @event
     * @blazorProperty 'MouseOver'     * @blazorType Syncfusion.EJ2.Blazor.Diagrams.IBlazorMouseEventArgs
     */
