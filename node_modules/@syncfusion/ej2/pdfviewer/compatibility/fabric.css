...
.e-menu-icon.e-pv-stamp-icon.e-pv-icon, .e-pv-annotation-stamp-container .e-menu-wrapper ul .e-menu-item .e-caret {
  margin-top: -7px;
}
...
.e-pv-annotation-textcolor-container.e-dropdown-btn.e-btn .e-caret, .e-pv-annotation-textalign-container.e-dropdown-btn.e-btn .e-caret, .e-pv-annotation-textprop-container.e-dropdown-btn.e-btn .e-caret {
  font-size: 12px;
}
