...
export interface MapsModel extends ComponentModel{
    ...
    /**
     * Triggers before the maps tooltip rendered.     * @event
     ...
     * @event     * @blazorProperty 'LegendRendering'
     */
    legendRendering?: EmitType<ILegendRenderingEventArgs>;

    /**
     * Triggers after the maps tooltip rendered.     * @event
