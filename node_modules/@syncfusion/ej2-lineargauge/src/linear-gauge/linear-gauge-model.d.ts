...
export interface LinearGaugeModel extends ComponentModel{
     ...
     * @event     * @blazorProperty 'AxisLabelRendering'
     */
     ...
     * @event     * @blazorProperty 'TooltipRendering'
     */
     ...
     * @event     * @blazorProperty 'ValueChange'
     */
