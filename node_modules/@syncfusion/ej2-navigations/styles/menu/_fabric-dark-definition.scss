...
$menu-ul-border: $menu-li-border-width $menu-li-border-style $neutral-light !default;
$menu-ul-header-padding: 0 16px !default;
$menu-ul-bigger-header-padding: 0 20px !default;
$menu-font-size: 13px !default;
$menu-ul-padding: 0 !default;
$menu-blank-icon: 30px !default;
$menu-separator-padding: 0 !default;
$menu-li-height: 42px !default;
$menu-li-padding: 0 8px !default;
$menu-li-text-indent: 8px !default;
$menu-icon-font-size: 14px !default;
$menu-icon-margin-right: 8px !default;
$menu-icon-width: auto !default;
...
$menu-disable-opacity: 1 !default;
$menu-li-right-padding: 8px !default;
$menu-bigger-font-size: 14px !default;
$menu-bigger-li-height: 52px !default;
$menu-bigger-li-padding: 0 10px !default;
$menu-bigger-li-text-indent: 10px !default;
$menu-icon-bigger-font-size: 16px !default;
$menu-bigger-caret-li-padding: 36px !default;
$menu-bigger-caret-font-size: 16px !default;
$menu-bigger-caret-right: 8px !default;
$menu-separator-bigger-padding: 0 !default;
$menu-blank-icon-bigger: 36px !default;
$menu-ul-bgcolor: $neutral-lighter !default;
$menu-li-border-color: $cmenu-li-border-color !default;
$menu-color: $cmenu-color !default;
$menu-seperator-border-color: $neutral-light !default;
...
$menu-li-selection-bgcolor: $neutral-quintenary !default;
...
$menu-srollbar-ul-border: 1px solid $menu-seperator-border-color !default;
...
$menu-icon-color: none !default;
$menu-icon-hover-color: transparent !default;
$menu-icon-focussed-color: none !default;
$menu-caret-color: transparent !default;
