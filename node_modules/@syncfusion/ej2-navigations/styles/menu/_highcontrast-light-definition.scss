$menu-bigger-li-right-padding: 10px;
$menu-bigger-icon-margin-right: 10px;
$menu-caret-padding-left: 10px;
$menu-li-border-style: solid;
$menu-li-border-width: 1px;
$menu-ul-border: none !default;
$menu-ul-header-padding: 0 16px;
$menu-ul-bigger-header-padding: 0 20px;
$menu-font-size: 14px !default;
$menu-ul-padding: 0 !default;
$menu-blank-icon: 34px !default;
$menu-separator-padding: 0 !default;
$menu-li-height: 36px !default;
$menu-li-padding: 0 16px !default;
$menu-li-text-indent: 16px !default;
$menu-icon-font-size: 14px !default;
$menu-icon-margin-right: 10px !default;
...
$menu-blank-icon-bigger: 42px !default;
$menu-ul-bgcolor: #fff !default;
$menu-li-border-color: $cmenu-li-border-color !default;
$menu-color: $cmenu-color !default;
$menu-seperator-border-color: $border-fg !default;
...
$menu-li-selection-bgcolor: #808080 !default;
