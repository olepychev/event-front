!function (e) {
    "use strict";
    var t, n, i, r, a, o, l, s, u, c, h = (t = e(window).width(), n = function () {
        e(".header").css("height", "");
        ...
        }), jQuery(".bns-menu .sub-menu").hide(), jQuery(".bns-menu > a").unbind().on("click", function (e) {
            e.preventDefault(), jQuery(".bns-menu > a").not(this).parent().find(".sub-menu").slideUp(), jQuery(this).parent().find(".sub-menu").toggle(500)
        ...
        if (e(".setResizeMargin").length > 0 && t >= 1280) {
            var n = e(".container").width(), i = (t - n) / 2;
            e(".setResizeMargin").css("margin-left", i)
        }
    }, a = function (t) {
        var n, i = 0, r = 0, a = new Array;
        e(t).each(function () {
            if (n = e(this), e(n).height("auto"), topPostion = n.position().top, r != topPostion) {
                for (currentDiv = 0; currentDiv < a.length; currentDiv++) a[currentDiv].height(i);
                a.length = 0, r = topPostion, i = n.height(), a.push(n)
            } else a.push(n), i = i < n.height() ? n.height() : i;
            for (currentDiv = 0; currentDiv < a.length; currentDiv++) a[currentDiv].height(i)
        })
    }, o = function () {
        ...
        e(".openbtn").on("click", function (t) {
            t.preventDefault(), e("#mySidenav").length > 0 && (document.getElementById("mySidenav").style.right = "0")
        }), e(".rightopen").on("click", function (t) {
            t.preventDefault(), e("#rightsidebar").length > 0 && (document.getElementById("rightsidebar").style.right = "0")
        }), e(".closebtn").on("click", function (t) {
            t.preventDefault(), e("#mySidenav").length > 0 && (document.getElementById("mySidenav").style.right = "-400px")
        }), e(".rightclose").on("click", function (t) {
            t.preventDefault(), e("#rightsidebar").length > 0 && (document.getElementById("rightsidebar").style.right = "-900px")
        })
    }, u = function () {
        var e = jQuery(this), t = e.find(".modal-dialog");
        e.css("display", "block"), t.css("margin-top", Math.max(0, (jQuery(window).height() - t.height()) / 2))
    }, (c = new Date).setMonth(c.getMonth() + 1), c = c.getDate() + " " + ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"][c.getMonth()] + " " + c.getFullYear(), {
        init: function () {
            var t, h, d;
            jQuery(".box-hover").on("mouseenter", function () {
                ...
                e(".price-slide, .price-slide-2").length > 0 && e("#slider-range-2").slider({
                    ...
                    values: [2, 100],
                    slide: function (t, n) {
                        var i = n.values[0], r = n.values[1];
                        e("#distance").val(i + "km - " + r + "km")
                    }
                })
            }(), t = parseInt(e(".onepage").css("height"), 10), e(".scroll").unbind().on("click", function (t) {
                if (t.preventDefault(), "" !== this.hash) {
                    var n = this.hash, i = e(n).offset().top, r = parseInt(e(".onepage").css("height"), 10);
                    e("body").scrollspy({target: ".navbar", offset: r + 2});
                    var a = i - r;
                    e("html, body").animate({scrollTop: a}, 800, function () {
                    })
                }
            }), e("body").scrollspy({
                target: ".navbar",
                offset: t + 2
            }), i(), n(), h = jQuery("#quik-search-btn"), d = jQuery("#quik-search-remove"), h.on("click", function () {
                ...
                if (jQuery(".sticky-header").length > 0) {
                    ...
                    e(window).scrollTop() > t.offset().top ? (t.addClass("is-fixed"), e(".header-transparent .logo-header .logo").attr("src", "images/logo-black.png")) : (t.removeClass("is-fixed"), e(".header-transparent .logo-header .logo").attr("src", "images/logo-white.png"))
                }
                ...
                e(".countdown").length && e(".countdown").countdown({date: t + " 23:5"}, function () {
            ...
            }), e(".full-height").css("height", e(window).height()), r(), jQuery(window).on("resize", function () {
            ...
            }), jQuery(".modal").on("show.bs.modal", u), jQuery("#lightgallery, .lightgallery ").length > 0 && (e("#lightgallery, .lightgallery").lightGallery({
                selector: ".check-km",
                loop: !0,
                thumbnail: !0,
                exThumbImage: "data-exthumbimage",
                share: !1
            }), e(".lightGalleryButton").on("click", function () {
                e(".check-km").trigger("click")
            }))
        }, load: function () {
            ...
            // jQuery("select").length && jQuery("select").selectpicker(),
                ...
                jQuery(".filters").length && jQuery(".filters").on("click", "li", function (n) {
                    n.preventDefault();
            ...
            t = e(window).width(), i(), n(), s(), l(), r()
        }
    });
    jQuery(document).ready(function () {
        h.init(), jQuery(".navicon").on("click", function () {
            e(this).toggleClass("open")
        })
    }), jQuery(window).on("load", function (e) {
        h.load(), setTimeout(function () {
